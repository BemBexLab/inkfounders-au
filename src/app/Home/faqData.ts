...
export const faqItems: FAQItem[] = [
  ...
  },
  {
    ...
    answerParagraphs: [
      "As a full-service book publishing company australia authors rely on, we cover the entire journey, editing, proofreading, formatting, cover design, ISBN and barcode registration,publishing, and marketing. You can use one service or the complete package, depending on where you are in your writing journey.",
    ],
  },
  {
  ...
  },
  {
    ...
    answerParagraphs: [
      "We work with authors across the australia, including our self-publishing agency serving Miami, Florida, as well as authors nationwide and internationally.",
    ],
  },
  {
    question:
