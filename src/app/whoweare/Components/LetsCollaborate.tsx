  ...
  return (
    <section className="flex w-full items-center justify-center bg-[#F6F5F3] px-4 py-10 sm:px-6 md:px-8">
      <div className="flex w-full max-w-[1400px] flex-col items-center rounded-3xl bg-[#F4F3E1] px-4 py-10 shadow-none sm:px-6 md:px-8">
        ...
        <h2 className=" max-w-5xl text-center text-[22px] font-semibold leading-tight text-[#222] sm:text-[25px] md:text-[32px]">
          Dreaming of becoming a published author?
        </h2>
        <p className={`text-black mt-1 mb-8`}>Ink Founders is here to bring your vision to life, one carefully crafted page at a time.</p>
